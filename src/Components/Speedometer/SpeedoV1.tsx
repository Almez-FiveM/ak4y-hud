    ...
    >
      ...
      >
        <Flex height={'100%'} align={'center'}>
          {speedo.speed < 10 && (
            <Text fontFamily={'Orbitron'} fontWeight={600} fontSize={'5em'} color={'#fff5'}>0</Text>
          )}
          {speedo.speed < 100 && (
            <Text fontFamily={'Orbitron'} fontWeight={600} fontSize={'5em'} color={'#fff5'}>0</Text>
          )}
          <Text fontFamily={'Orbitron'} fontWeight={600} fontSize={'5em'}>{speedo.speed}</Text>
        </Flex>
        <Flex
          justify={'center'}
          align={'center'}
      ...
      <Flex
        ...
        height={'2.2vh'}
      >
        <Text fontFamily={'Orbitron'} fontWeight={600} fontSize={'1.8em'} color={'#fff5'}>KMH</Text>
        ...
        />
        <Icons.CarDoor
          color={speedo.doors ? speedo.nitrousColor : '#DFDFDF'}
        />
      </Flex>
      <Flex
        align={'center'}

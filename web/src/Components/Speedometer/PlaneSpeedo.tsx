      ...
      >
        ...
        <Flex align={'center'} justify={'space-between'} w={'100%'} h={'100%'} py={'3vh'} flexDir={'column'}>
          <svg width="29" height="34" viewBox="0 0 29 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M0.335938 34.0093L14.3396 0.129395V34.0093H0.335938Z" fill="#FFEB3B" />
            <path fillRule="evenodd" clipRule="evenodd" d="M28.3433 34.0093L14.3396 0.129395V34.0093H28.3433Z" fill="#988B19" />
          </svg>

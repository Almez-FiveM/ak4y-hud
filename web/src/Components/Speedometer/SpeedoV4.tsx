...
const SpeedoV4 = () => {
  ...
  return (
    ...
    >
      <Flex width={'94%'} align={"center"} justify={"center"} pos={'absolute'} height={'100%'} zIndex={999}>
      ...
      <Flex width={'100%'} pos={'absolute'} height={'100%'}>
        <svg width="100%" height="100%"
          style={
            {
              filter: `drop-shadow(0px 0px 10px ${colord('#C99224').alpha(0.5).toHex()})`
            }
          }
          ...
          <path d="M136 272C100.301 272 66.0325 257.963 40.5917 232.919C15.1509 207.875 0.577516 173.831 0.0167777 138.136C-0.543961 102.441 12.9529 67.9569 37.5945 42.1258C62.2361 16.2948 96.0463 1.18845 131.728 0.067107C167.41 -1.05423 202.102 11.8993 228.317 36.1322C254.532 60.365 270.167 93.9337 271.849 129.594C273.531 165.253 261.124 200.145 237.306 226.737C213.487 253.329 180.168 269.49 144.539 271.732L144.317 268.203C179.02 266.019 211.473 250.279 234.672 224.378C257.87 198.477 269.955 164.493 268.317 129.76C266.679 95.0275 251.45 62.3315 225.917 38.7287C200.383 15.126 166.593 2.50919 131.839 3.60137C97.0851 4.69356 64.154 19.4071 40.1531 44.5666C16.1522 69.726 3.00619 103.314 3.55235 138.081C4.09851 172.848 18.293 206.006 43.0723 230.399C67.8517 254.792 101.229 268.464 136 268.464L136 272Z" stroke={'#C99224'} strokeWidth="20" mask="url(#path-1-inside-1_232_1007)" />
        </svg>
      </Flex>

      <Flex width={'100%'} pos={'absolute'} height={'100%'} transform={'rotate(180deg)'}>
        <svg width="100%" height="100%"
          style={
            {
              filter: `drop-shadow(0px 0px 10px ${colord('#50FFB5').alpha(0.5).toHex()})`
            }
          }
          ...
          <path d="M136 272C100.301 272 66.0325 257.963 40.5917 232.919C15.1509 207.875 0.577516 173.831 0.0167777 138.136C-0.543961 102.441 12.9529 67.9569 37.5945 42.1258C62.2361 16.2948 96.0463 1.18845 131.728 0.067107C167.41 -1.05423 202.102 11.8993 228.317 36.1322C254.532 60.365 270.167 93.9337 271.849 129.594C273.531 165.253 261.124 200.145 237.306 226.737C213.487 253.329 180.168 269.49 144.539 271.732L144.317 268.203C179.02 266.019 211.473 250.279 234.672 224.378C257.87 198.477 269.955 164.493 268.317 129.76C266.679 95.0275 251.45 62.3315 225.917 38.7287C200.383 15.126 166.593 2.50919 131.839 3.60137C97.0851 4.69356 64.154 19.4071 40.1531 44.5666C16.1522 69.726 3.00619 103.314 3.55235 138.081C4.09851 172.848 18.293 206.006 43.0723 230.399C67.8517 254.792 101.229 268.464 136 268.464L136 272Z" stroke={'#50FFB5'} strokeWidth="20" mask="url(#path-1-inside-1_232_1007)" />
        </svg>
      </Flex>
      ...
      <Flex
        ...
        bottom={'-1.8vh'}
      >
        <Icons.GasPump size={'.6vw'} color={'#C99224'} />
